...
public interface CircleGiveMapper {
     ...
     * @return
     */
    @Select("select b.avatar as giveAvatar from tb_browse a INNER JOIN tb_user b on a.u_id=b.id where a.zq_id=${zqId} group by a.u_id order by a.create_at desc  limit 8")
